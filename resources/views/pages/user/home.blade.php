...
<div class="p-6">
    ...
    <section class="min-h-[106px] bg-gradient-to-br from-[#fb923c] via-[#f97316] to-[#ff8a3d] rounded-[18px] text-white flex flex-col md:flex-row md:items-center justify-between gap-6 py-[22px] px-6 shadow-[0_18px_35px_rgba(249,115,22,0.24)]">
        ...
        <div class="flex flex-row md:flex-col gap-[9px] min-w-[150px] w-full md:w-auto">
            <a href="{{ route('user.map.evakuasi') }}" class="flex-1 text-white no-underline text-center text-xs font-black py-[9px] px-3 border border-white/50 rounded-[9px] bg-white/10 hover:bg-white/20 transition-colors">Jalur Evakuasi</a>
            <a href="{{ route('user.map.shelter') }}" class="flex-1 text-white no-underline text-center text-xs font-black py-[9px] px-3 border border-white/50 rounded-[9px] bg-white/10 hover:bg-white/20 transition-colors">Shelter Terdekat</a>
        </div>
    </section>
    ...
    <section class="mt-[22px] grid grid-cols-1 lg:grid-cols-[1fr_285px] gap-[22px] items-stretch">
        ...
        <aside class="p-[18px] bg-[#162238] text-white border border-[#e6ebf2] rounded-[18px] shadow-[0_14px_34px_rgba(15,23,42,0.06)]">
            ...
            <a class="mt-2.5 min-h-[62px] p-3 flex items-center gap-3 text-white no-underline rounded-[13px] bg-white/5 hover:bg-white/10 transition-colors" href="{{ route('user.map.faskes') }}">
            ...
            <a class="mt-2.5 min-h-[62px] p-3 flex items-center gap-3 text-white no-underline rounded-[13px] bg-white/5 hover:bg-white/10 transition-colors" href="{{ route('user.map.shelter') }}">
            ...
            <a class="mt-2.5 min-h-[62px] p-3 flex items-center gap-3 text-white no-underline rounded-[13px] bg-white/5 hover:bg-white/10 transition-colors" href="{{ route('user.map.evakuasi') }}">
            ...
            <a href="{{ route('user.tindakan-preventif.index') }}" class="inline-flex items-center gap-2 rounded-lg bg-orange-500 px-5 py-2.5 mt-3 w-full justify-center text-sm font-bold text-white transition hover:bg-orange-600 shadow-sm">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const evacuationRoutes = {!! json_encode($evacuationRoutes ?? []) !!};
    const allFeatures      = [];
