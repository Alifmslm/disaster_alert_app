...
<div class="min-h-screen bg-slate-50 p-6 md:p-8 font-sans text-slate-800">
    ...
    <div class="mb-6 flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
        ...
        <div class="flex items-center gap-3">
            <a href="<?php echo e(route('user.tindakan-preventif.edit', $tindakanPreventif->id)); ?>"
    ...
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-[1fr_320px]">
            ...
            <div class="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
                ...
                <div class="flex flex-col gap-5">
                    ...
                    <div>
                        ...
                        <p class="text-base font-bold text-slate-800"><?php echo e($tindakanPreventif->aktivitas); ?></p>
                    </div>
                    ...
                    <div>
                        ...
                        <p class="text-sm font-semibold text-slate-600 leading-relaxed whitespace-pre-line"><?php echo e($tindakanPreventif->deskripsi); ?></p>
                    </div>
            ...
            <div class="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
                ...
                <?php if($tindakanPreventif->foto): ?>
                    <div class="overflow-hidden rounded-xl border border-slate-100">
                        <img
                            src="<?php echo e(Storage::url($tindakanPreventif->foto)); ?>"
        ...
        <div class="flex flex-col gap-6">
                ...
                <div class="flex flex-col gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm font-bold text-slate-700">
                            <?php echo e(\Carbon\Carbon::parse($tindakanPreventif->created_at)->format('d M Y, H:i')); ?> WIB
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <p class="text-sm font-bold text-slate-700">
                            <?php echo e(\Carbon\Carbon::parse($tindakanPreventif->updated_at)->format('d M Y, H:i')); ?> WIB
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="rounded-xl border border-red-100 bg-red-50/50 p-6 shadow-sm">
                ...
                <form action="<?php echo e(route('user.tindakan-preventif.destroy', $tindakanPreventif->id)); ?>" method="POST"
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH Z:\internet_download\Kuliah Alif\SEMESTER 4\MANPROSI\disaster_alert_app\resources\views\pages\user\tindakan-preventif\show.blade.php ENDPATH**/ ?>