...
<div class="min-h-screen bg-slate-50 p-6 md:p-8 font-sans text-slate-800">
    ...
    <div class="mb-6">
        <p class="text-xs font-bold uppercase tracking-widest text-slate-400 mb-1">
            <a href="<?php echo e(route('user.home')); ?>" class="hover:text-orange-500 transition-colors">Beranda</a>
    ...
    <?php if(session('success')): ?>
        <div class="mb-6 rounded-xl border border-green-200 bg-green-50 p-4 flex items-start gap-3">
            ...
            <div>
                ...
                <p class="text-xs font-semibold text-green-700 mt-1"><?php echo e(session('success')); ?></p>
            </div>
        </div>
    <?php endif; ?>
    ...
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-[1fr_300px]">
        ...
        <div class="flex flex-col gap-6">
            ...
            <div class="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
                ...
                <form id="reportForm" action="<?php echo e(route('user.laporan-bencana.store')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="flex flex-col gap-8">
                            ...
                            <div class="flex flex-col gap-5">
                                ...
                                <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                                    <div>
                                        ...
                                        <input type="date" id="date" required max="<?php echo e(now()->format('Y-m-d')); ?>" class="w-full rounded-lg border border-slate-200 bg-slate-50 px-4 py-2.5 text-sm font-semibold text-slate-700 outline-none transition focus:border-orange-400 focus:bg-white focus:ring-2 focus:ring-orange-500/10">
                                    </div>
                                    <div>
                                ...
                                <div>
                                    ...
                                    <textarea id="description" name="description" required rows="5" maxlength="500" placeholder="Ceritakan detail kejadian secara singkat..." class="w-full resize-none rounded-lg border border-slate-200 bg-slate-50 px-4 py-2.5 text-sm font-semibold text-slate-700 placeholder:text-slate-400 placeholder:font-normal outline-none transition focus:border-orange-400 focus:bg-white focus:ring-2 focus:ring-orange-500/10"><?php echo e(old('description')); ?></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex flex-col-reverse gap-3 sm:flex-row sm:justify-end">
                            <a href="<?php echo e(route('user.home')); ?>" class="inline-flex items-center justify-center gap-2 rounded-lg border border-slate-200 bg-white px-6 py-2.5 text-sm font-bold text-slate-600 transition hover:bg-slate-50">
                                Batal
                            </a>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH Z:\internet_download\Kuliah Alif\SEMESTER 4\MANPROSI\disaster_alert_app\resources\views\pages\user\report-disaster.blade.php ENDPATH**/ ?>