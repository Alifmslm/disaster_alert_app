    ...
    <div class="max-w-[1160px] mx-auto">
        ...
        <section class="border border-slate-200 rounded-[14px] bg-white overflow-hidden shadow-[0_12px_30px_rgba(15,23,42,0.05)]">
            ...
            <div class="flex items-center gap-0 border-b border-slate-200 px-6 overflow-x-auto" role="tablist">
                <a href="<?php echo e(route('officer.kelola-data.laporan')); ?>" 
                   class="relative min-h-[62px] flex items-center pr-7 text-[13px] font-bold whitespace-nowrap transition-colors <?php echo e($currentTab === 'laporan' ? $activeClass : $inactiveClass); ?>">
                    Laporan Bencana
                </a>
                <a href="<?php echo e(route('officer.kelola-data.evakuasi.index')); ?>" 
                   class="relative min-h-[62px] flex items-center px-7 text-[13px] font-bold whitespace-nowrap transition-colors <?php echo e($currentTab === 'evakuasi' ? $activeClass : $inactiveClass); ?>">
                    Jalur Evakuasi
                </a>
                
                
                <a href="<?php echo e(route('officer.kelola-data.shelter.index')); ?>" 
                   class="relative min-h-[62px] flex items-center px-7 text-[13px] font-bold whitespace-nowrap transition-colors <?php echo e($currentTab === 'shelter' ? $activeClass : $inactiveClass); ?>">
                    Shelter & Posko
                </a>
                
                <a href="<?php echo e(route('officer.kelola-data.faskes.index')); ?>" 
                   class="relative min-h-[62px] flex items-center px-7 text-[13px] font-bold whitespace-nowrap transition-colors <?php echo e($currentTab === 'faskes' ? $activeClass : $inactiveClass); ?>">
                    Fasilitas Kesehatan
                </a>
                <a href="<?php echo e(route('officer.kelola-data.penanggulangan.index')); ?>" 
                   class="relative min-h-[62px] flex items-center px-7 text-[13px] font-bold whitespace-nowrap transition-colors <?php echo e($currentTab === 'penanggulangan' ? $activeClass : $inactiveClass); ?>">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH Z:\internet_download\Kuliah Alif\SEMESTER 4\MANPROSI\disaster_alert_app\resources\views\pages\officer\kelola-data\manage-data.blade.php ENDPATH**/ ?>