        ...
        <div class="absolute top-8 left-8 right-8 z-[500] flex flex-col gap-6 pointer-events-none">
            <div class="flex justify-between items-start w-full gap-4">
                ...
                <div class="pointer-events-auto flex p-1.5 bg-white/90 backdrop-blur-md rounded-xl shadow-md border border-white flex-wrap gap-1">
                    <a href="<?php echo e(route('user.map.laporan')); ?>"
                        class="flex items-center gap-2 px-4 py-2.5 rounded-lg transition-all text-xs font-bold tracking-wide uppercase
                        <?php echo e($activeTab === 'laporan' ? 'bg-[#FF7F3E] text-white shadow-md shadow-orange-200/50' : 'text-slate-600 hover:bg-slate-50 hover:text-orange-500'); ?>">
                        <i class="fas fa-triangle-exclamation text-sm"></i>
                        Laporan
                    </a>
                    <a href="<?php echo e(route('user.map.evakuasi')); ?>"
                        class="flex items-center gap-2 px-4 py-2.5 rounded-lg transition-all text-xs font-bold tracking-wide uppercase
                        <?php echo e($activeTab === 'evakuasi' ? 'bg-[#FF7F3E] text-white shadow-md shadow-orange-200/50' : 'text-slate-600 hover:bg-slate-50 hover:text-orange-500'); ?>">
                        <i class="fas fa-route text-sm"></i>
                        Jalur Evakuasi
                    </a>
                    <a href="<?php echo e(route('user.map.shelter')); ?>"
                        class="flex items-center gap-2 px-4 py-2.5 rounded-lg transition-all text-xs font-bold tracking-wide uppercase
                        <?php echo e($activeTab === 'shelter' ? 'bg-[#FF7F3E] text-white shadow-md shadow-orange-200/50' : 'text-slate-600 hover:bg-slate-50 hover:text-orange-500'); ?>">
                        <i class="fas fa-map-marker-alt text-sm"></i>
                        Shelter & Posko
                    </a>
                    <a href="<?php echo e(route('user.map.faskes')); ?>"
                        class="flex items-center gap-2 px-4 py-2.5 rounded-lg transition-all text-xs font-bold tracking-wide uppercase
                        <?php echo e($activeTab === 'faskes' ? 'bg-[#FF7F3E] text-white shadow-md shadow-orange-200/50' : 'text-slate-600 hover:bg-slate-50 hover:text-orange-500'); ?>">
                ...
                <div class="pointer-events-auto bg-white/95 backdrop-blur-md p-5 rounded-xl shadow-md border border-white w-52">
                    ...
                    <div class="space-y-3">
                        <?php $__currentLoopData = $legend; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex items-center gap-3">
                                <div class="w-3 h-3 rounded-full shrink-0"
                                    style="background-color: <?php echo e($item['color']); ?>; box-shadow: 0 0 0 4px <?php echo e($item['color']); ?>20;"></div>
                                <span class="text-xs font-bold text-slate-700"><?php echo e($item['label']); ?></span>
                            </div>
    ...
    <aside class="w-[420px] bg-white border-l border-slate-200 flex flex-col z-[500] shadow-[-10px_0_30px_rgba(0,0,0,0.03)]">
        <div class="p-8 pb-5 border-b border-slate-100">
            <div class="flex justify-between items-center">
                <h2 class="text-xl font-black text-slate-800 tracking-tight"><?php echo e($pageTitle); ?></h2>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    var rawData        = <?php echo json_encode($mapData ?? []); ?>;
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH Z:\internet_download\Kuliah Alif\SEMESTER 4\MANPROSI\disaster_alert_app\resources\views\pages\user\map-evacuation.blade.php ENDPATH**/ ?>